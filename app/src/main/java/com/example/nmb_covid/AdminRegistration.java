        ...
        firebaseAuth.createUserWithEmailAndPassword(email,password1).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AdminRegistration.this,"Successfully registered",Toast.LENGTH_LONG).show();
                    Intent intent=new Intent(AdminRegistration.this, Stastics.class);
                    startActivity(intent);
                    finish();
                }
                else{
                    Toast.makeText(AdminRegistration.this,"Sign up fail!",Toast.LENGTH_LONG).show();
                }
